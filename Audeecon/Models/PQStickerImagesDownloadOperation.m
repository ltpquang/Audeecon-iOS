    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        PQImageUriToDataDownloadOperation *thumbnailDownloadOperation = [[PQImageUriToDataDownloadOperation alloc]
                                                                         ...
                                                                         andComleteBlock:^(NSData *resultData) {
                                                                             ...
                                                                             [[NSNotificationCenter defaultCenter] postNotificationName:[PQNotificationNameFactory stickerCompletedDownloadingThumbnailImage:self.sticker.stickerId]
                                                                                                                                 object:self.sticker
                                                                                                                               userInfo:@{@"thumbnailImage":self.sticker.thumbnailImage}];
                                                                         }];
        ...
        PQImageUriToDataDownloadOperation *fullsizeDownloadOperation = [[PQImageUriToDataDownloadOperation alloc]
                                                                        ...
                                                                        andComleteBlock:^(NSData *resultData) {
                                                                            ...
                                                                            [realm commitWriteTransaction];
                                                                            [[NSNotificationCenter defaultCenter] postNotificationName:[PQNotificationNameFactory stickerCompletedDownloadingFullsizeImage:self.sticker.stickerId]
                                                                                                                                object:self.sticker];
                                                                        }];
